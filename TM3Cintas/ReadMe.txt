========================================================================
   APLICACIÓN: TM3Cintas Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación TM3Cintas.  

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación TM3Cintas.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado TM3Cintas.pch y un archivo de tipos 
